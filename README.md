...
Dotplot comparing GO Biological Process enrichment between genes upregulated (n = 546) and downregulated (n = 485) in the Thin versus Early contrast (|log2FC| > 1, adjusted p < 0.05) using compareCluster() in clusterProfiler. Dot size reflects gene ratio per term and color reflects Benjamini-Hochberg adjusted p-value. Upregulated genes are enriched for cytoplasmic translation, ribosome biogenesis, cellular and aerobic respiration, and energy derivation by oxidation of organic compounds, suggesting that the early transition to biofilm involves simultaneous upregulation of translational capacity and respiratory metabolism. Downregulated genes are enriched for glycolytic process, pyruvate metabolic process, and monocarboxylic acid metabolic process, indicating suppression of fermentative carbon catabolism even at the earliest stage of velum development.
