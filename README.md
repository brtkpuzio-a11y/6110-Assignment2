...
Gene set enrichment analysis was performed using gseGO(), with all genes passing independent filtering ranked by shrinkage-corrected log2 fold change from the Mature versus Early comparison. This approach complements threshold-dependent ORA by identifying coordinated expression shifts across predefined gene sets without requiring an arbitrary significance cutoff (Subramanian et al., 2005). All enrichment results were filtered at an adjusted p-value threshold of 0.05 and q-value below 0.2.

### Reproducibility
All code used in this analysis is publicly available and fully reproducible. The upstream quantification pipeline, including reference genome download, Salmon index construction, and transcript quantification, was implemented as  Bash shell scripts. Differential expression analysis, functional enrichment, and all visualizations were performed in R and are contained in a single annotated R script. All scripts can be executed end-to-end to reproduce all figures and results tables reported in this study. Raw RNA-seq data is publicly available from the NCBI Sequence Read Archive under BioProject accession PRJNA592304.
...
Differential expression analysis using DESeq2 identified transcriptional remodeling across all three pairwise contrasts. In the Thin versus Early comparison, 548 genes were significantly upregulated and 489 were downregulated (adjusted p < 0.05, |log2FC| > 1), indicating that transcriptional change occurs even at the earliest stage of velum development (Figure 5). The Mature versus Early contrast revealed the most extensive transcriptional differences, with 963 genes upregulated and 798 downregulated in the mature biofilm (Figure 4). Notable upregulated genes included FLO11, MAN2, and PIR1, while TDH1 and OLE1 were among the most significantly downregulated, consistent with a transition away from fermentative carbon metabolism. The Thin versus Mature comparison identified 534 upregulated and 688 downregulated genes, reflecting continued and partially reversed transcriptional dynamics between the intermediate and mature stages (Figure 6). The expression heatmap of the top 30 DEGs per pairwise contrast confirmed distinct expression patterns across stages, with clearly defined gene clusters corresponding to Early-enriched and Mature-enriched expression programs (Figure 7).
...
Row-scaled heatmap displaying the top 50 most significantly differentially expressed genes (adjusted p < 0.05, |log2FC| > 1) per pairwise contrast, deduplicated across comparisons. Expression values are variance-stabilized and z-score normalized per gene. Columns represent individual samples grouped by developmental stage (Early, Thin, Mature) without hierarchical clustering. Gene names are shown on the right.
...
Dotplot of the top 15 enriched GO Biological Process terms among significantly differentially expressed genes in the Thin versus Early contrast using clusterProfiler ORA. Dot size reflects gene count per term and color reflects Benjamini-Hochberg adjusted p-value. The full set of 5,571 expressed genes was used as the background universe.
...
<img width="2000" height="1500" alt="image" src="https://github.com/user-attachments/assets/2fd1625d-6723-433e-afee-a78a8f4f4a24" />
Figure 12. Comparative GO Biological Process enrichment between upregulated and downregulated gene sets in thin biofilm.
Dotplot comparing GO Biological Process enrichment between genes upregulated (n = 546) and downregulated (n = 485) in the Thin versus Early contrast using compareCluster() in clusterProfiler. Dot size reflects gene ratio per term and color reflects Benjamini-Hochberg adjusted p-value. Upregulated genes are enriched for cytoplasmic translation, ribosome biogenesis, cellular and aerobic respiration, and energy derivation by oxidation of organic compounds, suggesting that the early transition to biofilm involves simultaneous upregulation of translational capacity and respiratory metabolism. Downregulated genes are enriched for glycolytic process, pyruvate metabolic process, and monocarboxylic acid metabolic process, indicating suppression of fermentative carbon catabolism even at the earliest stage of velum development.

### Functional enrichment analysis
Over-representation analysis of significantly differentially expressed genes from the Mature versus Early contrast identified 47 enriched Gene Ontology Biological Process terms, 3 Molecular Function terms, and 15 Cellular Component terms (adjusted p < 0.05). The most significantly enriched BP terms included transmembrane transport, oxoacid metabolic process, organic acid metabolic process, and generation of precursor metabolites and energy, reflecting broad metabolic reprogramming during velum maturation (Figure 9). Directional comparison of upregulated and downregulated gene sets using compareCluster revealed an asymmetry in pathway enrichment (Figure 11). Among the 963 upregulated genes, enriched terms were associated with mitochondrial organization, respiratory chain complex assembly, mitochondrial translation, and protein folding, consistent with a shift toward oxidative metabolism. In contrast, the 798 downregulated genes were enriched for transmembrane transport, lipid metabolic processes, and organic acid catabolism, suggesting downregulation of fermentative and nutrient acquisition programs as the velum matures.

<img width="2000" height="1555" alt="image" src="https://github.com/user-attachments/assets/da695e59-8085-405e-90f8-08b8e849064b" />
Figure 13. KEGG pathway enrichment analysis of differentially expressed genes in the Mature versus Early comparison.
...
Figure 14. KEGG pathway enrichment analysis of differentially expressed genes in the Thin versus Early comparison.
Dotplot of the top 15 enriched KEGG pathways among significantly differentially expressed genes in the Thin versus Early contrast using enrichKEGG() with the *S. cerevisiae* organism code. Dot size reflects gene count per pathway and color reflects Benjamini-Hochberg adjusted p-value. Biosynthesis of secondary metabolites and Ribosome represent the most gene-rich enriched pathways, with additional enrichment of carbon metabolism, glycolysis/gluconeogenesis, and oxidative phosphorylation, indicating that the early stages of velum development involve broad upregulation of both biosynthetic and energy-generating metabolic pathways. The full set of 5,571 expressed genes was used as the background universe.


KEGG pathway enrichment analysis identified 16 significantly enriched pathways, with biosynthesis of secondary metabolites, carbon metabolism, and biosynthesis of amino acids representing the highest gene ratios (Figure 13). Additional enriched pathways included glycolysis/gluconeogenesis, pyruvate metabolism, oxidative phosphorylation, and fatty acid metabolism, collectively reinforcing the central role of metabolic rewiring in the transition to mature biofilm. Gene set enrichment analysis identified 203 significantly enriched GO Biological Process gene sets, providing further evidence for coordinated transcriptional shifts across a broad range of biological processes during velum maturation.

<img width="2000" height="1000" alt="image" src="https://github.com/user-attachments/assets/a51f454e-2403-4003-973c-6b54d427fbad" />
Figure 15. Normalized expression of selected genes of interest across velum developmental stages.
...
The enrichment of transmembrane transport among downregulated genes in mature velum cells is biologically interpretable in the context of the nutrient-depleted wine environment. Genes encoding hexose transporters, including HXT1 and HXT17, were among the most significantly downregulated in the Mature versus Early contrast, consistent with the near-complete depletion of glucose and other fermentable sugars from the wine at this stage of aging. The downregulation of high-affinity sugar transporters suggests that cells have transcriptionally adapted to the absence of fermentable carbon rather than maintaining expression of transport machinery for unavailable substrates. Similarly, the downregulation of DAL5, encoding an allantoate permease involved in nitrogen catabolite repression-sensitive transport, may reflect adaptation to the nitrogen-limited conditions of the aging wine environment.

### Early biofilm establishment and the Thin stage transcriptional program
Functional enrichment analysis of the Thin versus Early contrast revealed a biological signature that differs substantially from the Mature versus Early comparison, providing insight into the transcriptional events that initiate rather than sustain velum development. GO Biological Process enrichment of upregulated genes in the Thin stage identified cytoplasmic translation, ribosome biogenesis, cellular respiration, and aerobic respiration as the most significantly enriched terms (Figure 10, Figure 12), while downregulated genes were enriched for glycolytic process, pyruvate metabolic process, and monocarboxylic acid metabolic process. This pattern suggests that the earliest transcriptional response to biofilm initiation involves a coordinated upregulation of both translational capacity and respiratory metabolism, potentially reflecting the increased biosynthetic demand associated with the structural reorganization required for surface colonization.
The enrichment of ribosome biogenesis and cytoplasmic translation among upregulated genes in the Thin stage is notable, as ribosomal gene expression is coupled to growth rate and nutritional status in *S. cerevisiae*. The upregulation of these terms at the Thin stage, before their apparent decline in the mature biofilm, may reflect a transient burst of translational activity associated with the synthesis of cell wall proteins, adhesins, and metabolic enzymes required to establish the biofilm architecture. This interpretation is consistent with the KEGG enrichment results for the Thin versus Early contrast, which identified Ribosome as the second most gene-rich enriched pathway after biosynthesis of secondary metabolites, alongside carbon metabolism, glycolysis/gluconeogenesis, and oxidative phosphorylation (Figure 14).
The simultaneous enrichment of both glycolytic and oxidative phosphorylation pathways in the Thin versus Early KEGG analysis may reflect a mixed metabolic state during the transitional phase of biofilm development, in which cells have not yet fully committed to oxidative growth but are beginning to upregulate respiratory machinery in anticipation of fermentable carbon depletion. This transitional metabolic phenotype at the Thin stage contrasts with the more unambiguously oxidative transcriptional profile of the mature biofilm, and supports the interpretation of the Thin stage as a distinct and biologically meaningful intermediate rather than simply a point along a linear developmental continuum.
...
## Conclusion
Taken together, these findings reveal velum maturation as a progressive and highly coordinated transcriptional transition driven by the metabolic demands of oxidative growth in a nutrient-depleted, ethanol-rich environment. The upregulation of mitochondrial biogenesis, stress tolerance, cell wall adhesion, and membrane lipid remodeling programs, alongside the downregulation of fermentative metabolism and nutrient transport, reflects an adaptive response rather than a collection of independently regulated changes. The scope of transcriptional remodeling, affecting approximately 67% of the expressed genome, reinforces the extent to which velum formation represents a fundamental reorganization of cellular physiology, and highlights the transcriptional plasticity of *S. cerevisiae* in adapting to the extreme conditions of the biological wine aging environment.
## References 
